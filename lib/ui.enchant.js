 ...
 * @require image files for gamepad, icons (default: img/pad.png, img/apad.png, img/icon0.png, img/font1.png)
 *
 * @features
 ...
 * @type {Object}
 */
enchant.ui = { assets: ['img/pad.png', 'img/apad.png', 'img/icon0.png', 'img/font1.png'] };
...
enchant.ui.MutableText = enchant.Class.create(enchant.Sprite, {
    ...
    setText: function(txt) {
        ...
        for (i = 0; i < txt.length; i++) {
            ...
            this.image.draw(enchant.Game.instance.assets['img/font1.png'],
